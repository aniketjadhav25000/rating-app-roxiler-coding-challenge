...
function LoadingSpinner() {
  return (
    <div className="flex flex-col sm:flex-row justify-center items-center py-8 sm:py-12 space-y-3 sm:space-y-0">
      ...
      <span className="text-sm sm:text-lg text-gray-600 sm:ml-3">
        Loading dashboard...
      </span>
    </div>
  );
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-3">
          ...
          <div className="flex flex-col xs:flex-row gap-2 sm:gap-3">
            ...
            <div className="bg-blue-50 p-3 rounded-lg border border-blue-100 min-w-[120px] sm:min-w-[140px] order-1 xs:order-2">
              ...
              <div className="text-2xl sm:text-3xl font-bold text-blue-700 leading-none">
                {avg}
              </div>
              <Stars value={avg} />
...
export default function OwnerDashboard() {
  ...
  const handleDelete = async (id, name) => {
    ...
    try {
      ...
      setToast(
        `Error deleting store "${name}". Details: ${
    ...
    <div className="min-h-screen bg-gray-50">
      {toast && (
        <div className="fixed top-4 left-4 right-4 sm:left-1/2 sm:transform sm:-translate-x-1/2 sm:max-w-md z-50 animate-fadeInOut">
          <div
            className={`px-4 py-3 rounded-xl shadow-lg flex items-start gap-3 ${
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-white opacity-90 break-words mt-0.5">
                {toast}
              </p>
            </div>
          </div>
